...
ASK_LABEL_ID_MESSAGE = 'Введите ID заголовка для тренировки ответом на это сообщение'
...
ASK_COUNT_MESSAGE = 'Сколько карточек хотите повторить? Введите число ответом на это сообщение'
...
def get_label_received_message(label_text: str):
    return f'Для тренировки выбран заголовок {label_text}'
